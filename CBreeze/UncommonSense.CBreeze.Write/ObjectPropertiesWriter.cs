...
namespace UncommonSense.CBreeze.Write
{
	public static class ObjectPropertiesWriter
	{
		public static void Write(this ObjectProperties objectProperties, CSideWriter writer)
		{
            ...
            writer.WriteLineIf(objectProperties.DateTime.HasValue, "Date={0};", objectProperties.DateTime.ToShortDateString(writer.CodeStyle.DateFormat));
            writer.WriteLineIf(objectProperties.DateTime.HasValue, "Time={0};", objectProperties.DateTime.ToShortTimeString(writer.CodeStyle.TimeFormat));
